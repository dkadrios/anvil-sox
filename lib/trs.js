(function () {
  ...
  module.exports.use = function (trsFilename, panningFilename, reverbFilename) {
    var trsContents = fs.readFileSync(trsFilename)
          .toString()
          .split('\n'),
    ...
    panningContents.forEach(function (line, i) {
      panningContents[i] = parseInt(line.split(':')[1], 10);
    });

    reverbContents.forEach(function (line, i) {
      reverbContents[i] = parseInt(line.split(':')[1], 10);
    });

    trsContents.forEach(function (line, i) {
      var item = {},
          A = line.split(':');
  ...
  module.exports.find = function (item) {
    var result = null;

    this.entries.every(function (trsEntry) {
      var cont = true;
  ...
  module.exports.byNote = function (noteNum) {
    var result = null;
